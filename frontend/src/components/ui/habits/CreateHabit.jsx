...
const CreateHabit = ({ habits, addHabit }) => {
  ...
  return (
    <ul className="flex gap-2">
      ...
      {createHabitMenu && (
        <div className="flex flex-col gap-2 absolute mt-12 p-8 border border-gray-300 bg-white shadow-md rounded-md z-1">
          <label className="ml-5 text-gray-500">Habit</label>
          <input
          ...
          <button
            ...
            className="mt-2 w-1/2 m-auto border rounded-lg border-gray-100 text-gray-500 hover:bg-gray-50 active:bg-gray-100 transition duration-150 ease-in cursor-pointer"
          >
            Add
          </button>
        </div>
