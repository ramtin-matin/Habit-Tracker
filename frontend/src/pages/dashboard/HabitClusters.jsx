...
const HabitClusters  = () => {  
  return (
    ...
    <h1 className="md:shrink-0 text-5xl max-sm:text-4xl m-1 mb-2 font-bold text-emerald-600/75">My Habit Clusters.</h1>
    <p className="md:shrink-0 text-base max-sm:text-sm m-1 text-gray-500">Good habits don’t happen overnight. <b className="text-emerald-600/75">Small steps</b>, taken <b className="text-emerald-600/75">consistently</b>, lead to <b className="text-emerald-600/75">big changes.</b> <br></br>Stay <b className="text-emerald-600/75">patient</b>, stay <b className="text-emerald-600/75">consistent.</b></p>
      ...
      <div className="w-1/2 *:flex border-1 border-gray-200 items-center justify-start h-7/10 p-4 mt-2 rounded-sm">
        <div className="h-1/10 mx-auto transition duration-150 ease-in border-1 cursor-pointer hover:bg-gray-50 active:bg-gray-100 border-gray-200">
        </div>
      </div>
    </div>
  )
